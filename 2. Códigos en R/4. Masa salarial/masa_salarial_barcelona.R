...
# masa salarial F.C. Barcelona

datos %>%
  
  filter(equipo == "F.C. Barcelona") %>%                            # filtramos por equipo Barcelona
  ...
  geom_line(color = "#8b0000", linewidth = 1.2) +                   # ancho de la linea
  geom_point(color = "#8b0000", size = 2.5) +                       # tamaño del punto
  
  
  # titulos de los ejes
  
  labs(
    title = "Evolución de la masa salarial del F.C. Barcelona",
    x = "Año",
  ...
  scale_y_continuous(                                                      # modifica el eje y
    limits = c(0, 700000),                                                 # límites minimo y maximo
