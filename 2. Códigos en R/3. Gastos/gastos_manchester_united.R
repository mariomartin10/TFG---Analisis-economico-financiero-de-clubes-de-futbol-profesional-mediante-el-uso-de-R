...
# gastos manchester united

datos %>%
  
  filter(equipo == "Manchester United F.C.") %>%                    # filtramos por equipo Manchester United
  ...
  labs(
    title = "Evolución de los gastos del Manchester United F.C.",
    x = "Año",
    y = "Gastos (miles de €)",
    #color = "Club"
  ) +
