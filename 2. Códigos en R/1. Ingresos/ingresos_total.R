...
# Convertimos los ingresos a numéricos -> quitamos los puntos "." y lo pasamos a número
...
datos %>%
  ...
  # creamos el gráfico -> eje x = año, eje y = ingresos_totales, color = cada equipo
  
  ggplot(aes(x = año, y = ingresos_totales, color = equipo)) +
  ...
  labs(
    title = "Evolución de los ingresos totales",
    x = "Año",
